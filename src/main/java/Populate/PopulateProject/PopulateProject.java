...
public class PopulateProject {
    public static void populateProject(Project project) throws SQLException {
        PreparedStatement ps = Database.getInstance().getConnection().prepareStatement(Prefs.INSERT_INTO_PROJECT);
